...
import * as ControlUtils from "../utils/gameplay/ControlUtils.js";
...
import ParticleSystem from "../utils/animation/ParticleSystem.js";
import Color from "../utils/rendering/Color.js";
import Shaking from "../utils/animation/Shaking.js";
import PixelText from "../utils/gui/PixelText.js";
...
class Demo {
    ...
    constructor() {
        ...
        this.demoParticleSystem1 = new ParticleSystem({
            ...
            draw: particle => {
                const opacity = NumberUtils.clamp(particle.life / 2.0, 0.0, 1.0);
        ...
        this.demoParticleSystem2 = new ParticleSystem({
            ...
            particlesPerTick: 50,
            draw: particle => {
                const opacity = NumberUtils.clamp(particle.life / 0.7, 0.0, 1.0);
